...
<body>
    ...
    <div class="sidebar">
      ...
      <form action="admin_info_insert.php" class="form" method="POST">
                ...
                <div class="inputdiv">
                    <input type="text" name="tot_approvals" id="tot_approvals" required>
                    <label for="userlogin">tot_approvals</label>
                </div>
                <div class="inputdiv">
                    <input type="text" name="admin_fname" id="admin_fname" required>
                    <label for="userlogin">admin_fname</label>
                </div>
                <div class="inputdiv">
                    <input type="text" name="admin_lname" id="admin_lname" required>
                    <label for="userlogin">admin_lname</label>
                </div>
            
                <input type="submit" value="submit" class="submitbtn">
            </form>
            <form action="admin_info_delete.php" class="form" method="POST">

            <h2>Enter the admin username to be deleted</h2>
         <div class="inputdiv">
